...
const Opportunity: SObjectDescribe = {
  ...
  fields: [
    ...
    { name: 'StageName',         label: 'Stage',           type: 'picklist',  nillable: false, picklistValues: ['Prospecting','Qualification','Discovery','Proposal','Negotiation','Closed Won','Closed Lost'] },
    ...
    { name: 'LeadSource',        label: 'Lead Source',     type: 'picklist',  nillable: true,  picklistValues: ['Inbound','Outbound','Partner','Event'] },
  ],
  childRelationships: [
...
const Account: SObjectDescribe = {
  ...
  fields: [
    ...
    { name: 'Industry',      label: 'Industry',       type: 'picklist',  nillable: true,  picklistValues: ['Software','Manufacturing','Healthcare','FinServ','Retail'] },
...
const Lead: SObjectDescribe = {
  ...
  fields: [
    ...
    { name: 'Status',      label: 'Lead Status',  type: 'picklist',  nillable: false, picklistValues: ['New','Working','Qualified','Unqualified'] },
    { name: 'LeadSource',  label: 'Lead Source',  type: 'picklist',  nillable: true,  picklistValues: ['Inbound','Outbound','Partner','Event'] },
    { name: 'CreatedDate', label: 'Created Date', type: 'datetime',  nillable: false },
...
const User: SObjectDescribe = {
  ...
  fields: [
    ...
    { name: 'Role',  label: 'Role',    type: 'picklist', nillable: false, picklistValues: ['AE','SDR','Manager','RevOps'] },
...
const Activity: SObjectDescribe = {
  ...
  fields: [
    ...
    { name: 'Type',         label: 'Type',        type: 'picklist',  nillable: false, picklistValues: ['Call','Email','Meeting','Note','StageChange'] },
    { name: 'Subject',      label: 'Subject',     type: 'string',    nillable: false },
